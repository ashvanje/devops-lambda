...
exports.handler = async (event, context) => {
    ...
    const bucket = "conjur-ct1-backup";
    ...
    const params = {
        Bucket: bucket,
        Prefix: "t0/" + day1dayAgo //query the day of month
    };
    const ssmParam = {
      "ParameterFilters": [ 
          { 
    ...
    try {
        ...
        if(noNewBackup || noNewParameters) {
...
async function publishNoBackupToSns() {
    ...
    var content = fs.readFileSync("conjur_ete_no_backup_alert_msg.txt", "utf8")
    ...
    const params = {
        TopicArn: snsTopic,
        Subject: "Alert from DevSecOps: No new Conjur Ete Backup in 1 day",
        Message: content,  
    };
...
async function publishSuccessfulBackupToSns() {
    ...
    var content = fs.readFileSync("conjur_ete_successful_backup_alert_msg.txt", "utf8")
    ...
    const params = {
        TopicArn: snsTopic,
        Subject: "Alert from DevSecOps: Successful Conjur Ete Backup in 1 day",
        Message: content,  
    };
